//
//  TherapyCenterReviewsViewController.swift
//  Fathce
//
...
class TherapyCenterReviewsViewController: UIViewController {
    ...
    @IBAction func menuBtnClicked(_ sender: UIBarButtonItem) {
        ...
        extension TherapyCenterReviewsViewController  :UIViewControllerTransitioningDelegate
        {
